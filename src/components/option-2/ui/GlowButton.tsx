...
export function GlowButton({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 px-6 py-2.5 md:px-8 md:py-3 text-sm md:text-base font-semibold rounded-xl transition-all duration-300 group hover:scale-105";
