...
export function DeviceMockup({ desktopSrc, laptopSrc, mobileSrc, alt, priority = false }: DeviceMockupProps) {
  return (
    ...
    >
      ...
      <div
        className="absolute -bottom-8 -left-10 w-[55%] rounded-md border border-zinc-700/40 bg-zinc-900/90 p-1 shadow-xl z-10 animate-fade-in-up [animation-delay:600ms]"
      ...
      <div
        className="absolute -bottom-4 -right-4 w-[22%] rounded-xl border border-zinc-700/40 bg-zinc-900/90 p-1 shadow-xl z-20 animate-fade-in-up [animation-delay:800ms]"
